...
export type RuntimeUnknownPageCandidate = Omit<BusinessNode, "id">;

export function buildRuntimeUnknownPageCandidate(graphVersionId: string, observation: Observation, match: NodeMatchResult | undefined): RuntimeUnknownPageCandidate {
  ...
  return {
    ...
    metadata: {
      ...
      createdFrom: {
        type: "page_identity_observation",
...
export function mergeRuntimeUnknownPageMetadata(
