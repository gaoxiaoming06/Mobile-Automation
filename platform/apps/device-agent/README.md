...
For source development without watch, use the root script:

```bash
pnpm agent:https
```

Both scripts connect to `https://127.0.0.1:4010`, set `DEVICE_AGENT_SHARED=1`, and disable certificate verification for the local self-signed certificate.
