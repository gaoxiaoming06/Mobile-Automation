...
export type RoutePlanIssue = {
  code:
    ...
    | "PAGE_ELEMENT_MIXED_TRANSITION_FIELD"
    | "PAGE_TRANSITION_MIXED_ELEMENT_FIELD"
    | "PAGE_TRANSITION_ELEMENT_MISSING"
    | "PAGE_TRANSITION_TARGET_MISSING"
    | "PAGE_TRANSITION_TARGET_NOT_FOUND";
